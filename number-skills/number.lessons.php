...
// Fetch Quiz Scores
$stmt = $conn->prepare("SELECT num_quiz1, num_quiz2, num_quiz3 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
// Fetch Highest Emotion for each lessons
$stmt2 = $conn->prepare("SELECT num_quiz1, num_quiz2, num_quiz3 FROM quiz_emotions WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Num. Skills - Lessons</title>
...
<body class="lessons-page">
    ...
    <div class="subject-container">
        <h1 class="choose-subject speak-on-hover" data-label="Number Skills">NUMBER SKILLS</h1>
        <h2 class="speak-on-hover" data-label="Choose a lesson" style="color: white;">CHOOSE A LESSON</h2>
        <div class="lesson-buttons">
            <button class="lesson-btn speak-on-hover" data-label="Lesson 1" onclick="window.location.href='number.lesson1.php'">
                Lesson 1<br>
            ...
            <button class="lesson-btn speak-on-hover" data-label="Lesson 2" onclick="window.location.href='number.lesson2.php'">
                Lesson 2<br>
                <span style="display:block; border-bottom:2px solid #222; margin:8px 0;"></span>
            ...
            <button class="lesson-btn speak-on-hover" data-label="Lesson 3" onclick="window.location.href='number.lesson3.php'">
                Lesson 3<br>
                <span style="display:block; border-bottom:2px solid #222; margin:8px 0;"></span>
