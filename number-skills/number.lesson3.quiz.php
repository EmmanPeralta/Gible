...
$stmt_prev = $conn->prepare("SELECT num_quiz3 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Number Skills - Lesson 3 - Quiz</title>
    ...
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                ...
                img: '../images/NumberSkills/Quiz/triangle.png',
                options: [
                    "△ - 2 (Two)",
                    "〇 - 3 (Three)", 
                    "✖ - 4 (Four)", 
            ...
            },
            {
                ...
                img: '../images/NumberSkills/Quiz/square.jpg',
                options: [
                    "△ - 4 (Four)", 
                    "〇 - 5 (Five)", 
                    "✖ - 6 (Six)", 
            ...
            },
            {
                ...
                img: '../images/NumberSkills/Quiz/rectangle.png',
                options: [
                    "△ - 3 (Three)", 
                    "〇 - 5 (Five)", 
                    "✖ - 6 (Six)", 
            ...
            {
                question: "How many sides do 2 triangles have in total?", 
                img: '../images/NumberSkills/Quiz/twotriangle.png',
                options: [
                    "△ - 4 (Four)", 
                    "〇 - 5 (Five)", 
                    "✖ - 6 (Six)", 
            ...
            {
                question: "How many sides do 2 squares have in total?", 
                img: '../images/NumberSkills/Quiz/twosquare.png',
                options: [
                    "△ - 8 (Eight)",
                    "〇 - 7 (Seven)", 
                    "✖ - 6 (Six)",
            ...
            {
                question: "How many sides do 1 square and 1 rectangle have in total?", 
                img: '../images/NumberSkills/Quiz/squarectangle.png',
                options: [
                    "△ - 8 (Eight)",
                    "〇 - 7 (Seven)", 
                    "✖ - 6 (Six)",
            ...
            {
                question: "How many sides do 2 rectangles have in total?", 
                img: '../images/NumberSkills/Quiz/tworectangle.png',
                options: [
                    "△ - 4 (Four)",
                    "〇 - 1 (One)", 
                    "✖ - 7 (Seven)",
            ...
            {
                question: "How many sides do 2 circles have in total?", 
                img: '../images/NumberSkills/Quiz/twocircle.png',
                options: [
                    "△ - 2 (Two)", 
                    "〇 - 4 (Four)", 
                    "✖ - 0 (Zero)", 
            ...
            {
                question: "How many sides do 1 circle and 1 triangle have in total?", 
                img: '../images/NumberSkills/Quiz/trianglecircle.png',
                options: [
                    "△ - 3 (Three)", 
                    "〇 - 0 (Zero)", 
                    "✖ - 2 (Two)", 
            ...
            {
                question: "How many sides do 1 triangle and 1 square have in total?",
                img: '../images/NumberSkills/Quiz/trianglesquare.png',
                options: [
                    "△ - 2 (Two)", 
                    "〇 - 4 (Four)", 
                    "✖ - 7 (Seven)", 
            ...
            function showQuestion() {
                ...
                document.getElementById('question-box').innerHTML =
                    ...
                    (window.questions[window.currentQuestion].img ? `<img src="${window.questions[window.currentQuestion].img}" alt="" style="max-width:300px;display:block;margin:12px auto;">` : '') +
                    optionsMarkup +
                    `</div>`;
