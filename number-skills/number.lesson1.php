...
<title>Number Skills - Lesson 1</title>
...
<div class="lesson-slider">
    <div class="slider-header speak-on-hover" data-label="Number Lesson 1">Number Lesson 1</div>
...
<script>
    window.addEventListener('DOMContentLoaded', function () {
        const slides = [
        { img: '../images/NumberSkills/Lessons/number.lesson1.page1.jpg', label: "In this lesson, you will learn about: basic numbers."},
        { img: '../images/NumberSkills/Lessons/number.lesson1.page2.jpg', label: "Numbers help us count how many things there are, Like this boy who tries to count the building blocks" },
        { img: '../images/NumberSkills/Lessons/number.lesson1.page3.jpg', label: "Small Numbers like 1 to 10 are used when there are just a few things." }
    ];

    if (typeof mountLessonSlider === 'function') {
        mountLessonSlider({ slides, quizHref: 'number.lesson1.quiz.php' });
    }
    });
</script>
