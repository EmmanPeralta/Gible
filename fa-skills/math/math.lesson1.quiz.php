...
$stmt_prev = $conn->prepare("SELECT math_quiz1 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Math Skills - Lesson 1 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            ...
            {
                question: "What number comes just BEFORE 20?",
                options: [
                    "△ - 19", 
                    "〇 - 21", 
                    "⨉ - 18",
            ...
            {
                question: "Which number has the number 3 with 0 BESIDE it?",
                options: [
                    "△ - 13",
                    "〇 - 3", 
                    "⨉ - 33",
            ...
            {
                question: "What number comes just BEFORE 29?",
                options: [
                    "△ - 28", 
                    "〇 - 30",
                    "⨉ - 31",
            ...
            {
                question: "Which number comes just BEFORE 50?",
                options: [
                    "△ - 39",
                    "〇 - 40",
                    "⨉ - 49", 
            ...
            {
                question: "Which number has the number 4 with 0 BESIDE it?", 
                options: [
                    "△ - 14",
                    "〇 - 40", 
                    "⨉ - 49",
            ...
            { 
                question: "What number comes just AFTER 41?", 
                options: [
                    "△ - 14",
                    "〇 - 40",
                    "⨉ - 42", 
            ...
            {
                question: "Which group of number counts up by 1?", 
                options: [
                    "△ - 14, 16, 18",
                    "〇 - 40, 30, 20",
                    "⨉ - 31, 32, 33", 
