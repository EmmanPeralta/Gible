...
$stmt_prev = $conn->prepare("SELECT math_quiz2 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Math Skills - Lesson 2 - Quiz</title>
    ...
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                ...
                img: '../../images/Math/Quiz/math.quiz4-1.png" style="height:150px;',
                options: [
                    "△ - 18",
                    "〇 - 19",
                    "⨉ - 20", 
            ...
            },
            {
                ...
                img: '../../images/Math/Quiz/math.quiz4-2.png" style="height:200px;',
                options: [
                    "△ - 27",
                    "〇 - 28",
                    "⨉ - 29", 
            ...
            },
            {
                ...
                img: '../../images/Math/Quiz/math.quiz4-3.png" style="height:200px;',
                options: [
                    "△ - 21",
                    "〇 - 22", 
                    "⨉ - 23",
            ...
            {
                question: "What is 9 + 18?",
                img: '../../images/Math/Quiz/math.quiz4-4.png" style="height:200px;',
                options: [
                    "△ - 25",
                    "〇 - 26",
                    "⨉ - 27", 
            ...
            {
                question: "What is 6 + 24?",
                img: '../../images/Math/Quiz/math.quiz4-5.png" style="height:200px;',
                options: [
                    "△ - 28",
                    "〇 - 29",
                    "⨉ - 30", 
            ...
            },
            {
                ...
                img: '../../images/Math/Quiz/math.quiz4-6.png" style="height:200px;',
                options: [
                    "△ - 34",
                    "〇 - 35", 
                    "⨉ - 36",
            ...
            },
            {
                ...
                img: '../../images/Math/Quiz/math.quiz4-7.png" style="height:200px;',
                options: [
                    "△ - 25",
                    "〇 - 26", 
                    "⨉ - 27",
            ...
            },
            {
                ...
                img: '../../images/Math/Quiz/math.quiz4-8.png" style="height:200px;',
                options: [
                    "△ - 26",
                    "〇 - 27", 
                    "⨉ - 28",
            ...
            {
                question: "What is 4 + 39?",
                img: '../../images/Math/Quiz/math.quiz4-9.png" style="height:200px;',
                options: [
                    "△ - 42",
                    "〇 - 43", 
                    "⨉ - 44",
            ...
            {
                question: "What is 28 + 9?",
                img: '../../images/Math/Quiz/math.quiz4-10.png" style="height:200px;',
                options: [
                    "△ - 36",
                    "〇 - 37", 
                    "⨉ - 38",
