...
<title>Math Skills - Lesson 1</title>
...
<div class="lesson-slider">
    <div class="slider-header speak-on-hover" data-label="Math Lesson 1">Math Lesson 1</div>
...
<script>
    ...
    const slides = [
        {
            img: '../../images/Math/Lessons/math.lesson1.page1.png',
            label: "In this lesson, we will learn how to count and know numbers up to 50"
        },
        {
            img: '../../images/Math/Lessons/math.lesson1.page2.png',
            label: "Numbers like 10, 20, 30, 40, and 50 are like 1, 2, 3, 4, and 5 but with a number 0 beside them"
        },
        {
            img: '../../images/Math/Lessons/math.lesson1.page3.png',
            label: "Numbers after 10 go like this: 11, 12, 13, 14, 15, 16, 17, 18, 19, and 20"
        },
        {
            img: '../../images/Math/Lessons/math.lesson1.page4.png',
            label: "It is the same for 20, 30, 40 and 50 - just change the number 0, then count again from 1 to 9"
        },
    ];

    if (typeof mountLessonSlider === 'function') {
        mountLessonSlider({ slides, quizHref: 'math.lesson1.quiz.php' });
    }
    });
    </script>
