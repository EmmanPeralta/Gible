...
$stmt_prev = $conn->prepare("SELECT sci_quiz1 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Science Skills - Lesson 1 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "Which of the following is a SOLID object",
                options: [
                    "△ <img src='../../images/Science/Quiz/liquid1.png' style='width:200px;height:auto;'>",
                    "〇 <img src='../../images/Science/Quiz/gas1.png' style='width:145px;height:auto;'>",
                    "✖ <img src='../../images/Science/Quiz/solid1.png' style='width:130px;height:auto;'>", 
                    "☐ - None"
                ],
                correct: 2 // ✖
            },
            {
                question: "Which of the following is in a GAS form?",
                options: [
                    "△ <img src='../../images/Science/Quiz/gas1.png' style='width:145px;height:auto;'>", 
                    "〇 <img src='../../images/Science/Quiz/liquid1.png' style='width:200px;height:auto;'>",
                    "✖ <img src='../../images/Science/Quiz/solid1.png' style='width:130px;height:auto;'>",
                    "☐ - None"
                ],
                correct: 0 // △
            ...
            {
                question: "Which of the following is in a LIQUID form?",
                options: [
                    "△ <img src='../../images/Science/Quiz/solid1.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../../images/Science/Quiz/liquid1.png' style='width:200px;height:auto;'>", 
                    "✖ <img src='../../images/Science/Quiz/gas1.png' style='width:145px;height:auto;'>",
            ...
            {
                question: "What do you call if an object easily flows and changes shape based on the area?",
                options: [
                    "△ - Solid",
                    "〇 - Liquid", 
                    "✖ - Gas",
            ...
            {
                question: "If an object is hard, not easily broken, and does not change shape. What kind of form is that object?",
                options: [
                    "△ - Solid", 
                    "〇 - Liquid", 
                    "✖ - Gas",
            ...
            {
                question: "If a form freely moves around the area and fills all of it, what do you call its form?",
                options: [
                    "△ - Solid", 
                    "〇 - Liquid", 
                    "✖ - Gas", 
            ...
            {
                question: "Which one of the following is not LIQUID? ",
                options: [
                    "△ <img src='../../images/Science/Quiz/liquid1.png' style='width:200px;height:auto;'>",
                    "〇 <img src='../../images/Science/Quiz/liquid3.png' style='width:120px;height:auto;'>",
                    "✖ <img src='../../images/Science/Quiz/liquid2.png' style='width:130px;height:auto;'>",
                    "☐ <img src='../../images/Science/Quiz/gas2.png' style='width:105px;height:auto;'>" 
                ],
                correct: 3 // ☐
            },
            {
                question: "Which one of the following is not SOLID?",
                options: [
                    "△ <img src='../../images/Science/Quiz/solid3.png' style='width:200px;height:auto;'>",
                    "〇 <img src='../../images/Science/Quiz/solid1.png' style='width:180px;height:auto;'>",
                    "✖ <img src='../../images/Science/Quiz/liquid2.png' style='width:180px;height:auto;'>", 
                    "☐ <img src='../../images/Science/Quiz/solid2.png' style='width:120px;height:auto;'>"
                ],
                correct: 2 // ✖ 
            },
            {
                question: "Which one of the following is not GAS?",
                options: [
                    "△ <img src='../../images/Science/Quiz/solid3.png' style='width:200px;height:auto;'>", 
                    "〇 <img src='../../images/Science/Quiz/gas1.png' style='width:200px;height:auto;'>",
                    "✖ <img src='../../images/Science/Quiz/gas3.png' style='width:150px;height:auto;'>", 
                    "☐ <img src='../../images/Science/Quiz/gas2.png' style='width:145px;height:auto;'>"
                ],
                correct: 0 // △
            },
            {
                question: "From left to right, tell which form does these three objects take.",
                img: '../../images/Science/Quiz/liquid,gas,solid.png" style="height:200px;',
                options: [
                    "△ -  SOLID, LIQUID, GAS", 
                    "〇 - SOLID, SOLID, LIQUID",
                    "✖ - SOLID, GAS, SOLID",
                    "☐ - LIQUID, GAS, SOLID" 
                ],
                correct: 3 // ☐
            ...
            function showQuestion() {
                ...
                if (window.currentQuestion >= window.questions.length) {
                    ...
                    resultBox.innerHTML = `
                        <div id="result-content" class="result-content">
                            ...
                            <!-- Bottom Button Row -->
                                <button class="back-button speak-on-hover" data-label="Back to Functional Academics" style="padding:0.6rem 1.2rem; font-size:1.1rem; margin-top: 5px" onclick="saveScoreAndGoBack()">
                                    Back to Functional Academics
                                </button>
                        </div>
                    `;
                ...
                // implements pronunciation fix
                function optionToTTSWithPronunciation(optionHtml, idx) {
                    let text = optionToTTSWithShape(optionHtml, idx); // get base text
                    text = text.replace(/\b(AH|UH|EH|IH|OH)\b/g, (match) => pronounceSound(match));
                    return text;
                }
                ...
                let optLabels = [
                    `Triangle for. ${pronounceSound(extractAnswer(opts[0], 0))}`,
                    `Circle for. ${pronounceSound(extractAnswer(opts[1], 1))}`,
                    `Cross for. ${pronounceSound(extractAnswer(opts[2], 2))}`,
                    `Square for. ${pronounceSound(extractAnswer(opts[3], 3))}`
                ];
        ...
        <script>
            ...
            fetch('../../save_quiz_result.php', {
                ...
                .then(() => {
                    window.location.href = '../fa.lessons.php';
                })
                .catch(() => {
                    window.location.href = '../fa.lessons.php';
                });
