...
$stmt_prev = $conn->prepare("SELECT sci_quiz2 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Science Skills - Lesson 2 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "What makes some things melt or freeze?",
                options: [
                    "△ - The wind",
                    "〇 - Constant temperature", 
                    "✖ - The color",
                    "☐ - The shape"
                ],
                correct: 1 // 〇
            ...
            {
                question: "What happens to a solid when it gets hot?",
                options: [
                    "△ - It freezes",
                    "〇 - It melts", 
                    "✖ - It breaks",
            ...
            },
            {
                ...
                options: [
                    "△ - It turns into ice",
                    "〇 - It boils and turns into steam", 
                    "✖ - It turns into solid",
                    "☐ - Stays the same"
                ],
                correct: 1 // 〇
            ...
            {
                question: "What do we call when a liquid turns solid because of low temperatures?",
                options: [
                    "△ - Boiling",
                    "〇 - Melting",
                    "✖ - Freezing", 
            ...
            {
                question: "When water freezes, what does it become?",
                options: [
                    "△ - Ice", 
                    "〇 - Steam",
                    "✖ - Gas",
            ...
            {
                question: "When water boils, what comes out as gas?",
                options: [
                    "△ - Dust",
                    "〇 - Steam", 
                    "✖ - Fire",
            ...
            {
                question: "What happens to a liquid if temperatures don't change?",
                options: [
                    "△ - Freezes and turns into Solid",
                    "〇 - Boils and turns into Gas", 
                    "✖ - It changes shape only",
                    "☐ - It stays the same" 
                ],
                correct: 3 // ☐
            },
            {
                question: "What do we call it when a solid slowly becomes liquid?",
                options: [
                    "△ - Melting", 
                    "〇 - Boiling",
                    "✖ - Freezing",
            ...
            {
                question: "What is an example of solid to liquid change?",
                options: [
                    "△ - Ice to water", 
                    "〇 - Water to steam",
                    "✖ - Water to ice",
            ...
            {
                question: "What is an example of liquid to gas change?",
                options: [
                    "△ - Water to ice",
                    "〇 - Boiling water to steam", 
                    "✖ - Steam to ice",
                    "☐ - Ice to water"
                ],
                correct: 1 // 〇
