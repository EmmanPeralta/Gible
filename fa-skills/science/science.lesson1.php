...
<title>Science Skills - Lesson 1</title>
...
<div class="lesson-slider">
    <div class="slider-header speak-on-hover" data-label="Science Lesson 1">Science Lesson 1</div>
...
<script>
    ...
    const slides = [
        {
            img: '../../images/Science/Lessons/science.lesson1.page1.png',
            label: "In this lesson, we will learn about the 3 matters. Solid, Liquid, and Gas."
        },
        {
            img: '../../images/Science/Lessons/science.lesson1.page2.png',
            label: "Solid matter is made up of things that keep their own shape and do not change based on the space or area they are in. These are objects that are hard or not easily broken. For example, a log of wood."
        },
        {
            img: '../../images/Science/Lessons/science.lesson1.page3.png',
            label: "Liquid matter is a form of matter that flows easily. It always changes its shape based on the container or area it is placed in. For example, water in a glass always takes the same shape as the glass."
        },
        {
            img: '../../images/Science/Lessons/science.lesson1.page4.png',
            label: "Gas matter is a form of matter that we cannot see. It moves freely and fills any space around it, spreading throughout the area. For example, the air that we breathe, and the vapor when the water boils."
        },
    ];

    if (typeof mountLessonSlider === 'function') {
        mountLessonSlider({ slides, quizHref: 'science.lesson1.quiz.php' });
    }
    });
    </script>
