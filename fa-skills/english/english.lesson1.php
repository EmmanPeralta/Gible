...
<title>English Skills - Lesson 1</title>
...
<div class="lesson-slider">
    <div class="slider-header speak-on-hover" data-label="English Lesson 1">English Lesson 1</div>
...
<script>
    ...
    const slides = [
        {
            img: '../../images/English/Lessons/english.lesson1.page1.png',
            label: "In this lesson, we will learn about the sound of vowels. There are 5 vowel letters in the alphabet: a, e, i, o, u."
        },
        {
            img: '../../images/English/Lessons/english.lesson1.page2.png',
            label: "a sounds like AH as in apple, e sounds like EH as in egg, i sounds like IH as in igloo."
        },
        {
            img: '../../images/English/Lessons/english.lesson1.page3.png',
            label: "o sounds like OH as in orange, and u sounds like UH as in umbrella."
        },
    ];

    if (typeof mountLessonSlider === 'function') {
        mountLessonSlider({ slides, quizHref: 'english.lesson1.quiz.php' });
    }
    });
    </script>
