...
$stmt_prev = $conn->prepare("SELECT eng_quiz2 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>English Skills - Lesson 2 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "Which one is a sight word?",
                options: [
                    "△ - banana",
                    "〇 - dog",
                    "✖ - the", 
            ...
            {
                question: "Which one is a sight word used in reading?",
                options: [
                    "△ - school",
                    "〇 - here", 
                    "✖ - laptop",
            ...
            {
                question: "Which word is a sight word we see many times?",
                options: [
                    "△ - chair",
                    "〇 - some", 
                    "✖ - bread",
            ...
            {
                question: "Which word can complete this sentence? '_____ name is Ana.'",
                options: [
                    "△ - they",
                    "〇 - my",
                    "✖ - her", 
            ...
            {
                question: "Which word can fit here? 'May I go _____?'",
                options: [
                    "△ - fast",
                    "〇 - house",
                    "✖ - now", 
            ...
            {
                question: "Which sight word is used to ask a question?",
                options: [
                    "△ - cat",
                    "〇 - run",
                    "✖ - what", 
            ...
            {
                question: "Which word fits in this sentence? 'They are ______.'",
                options: [
                    "△ - running",
                    "〇 - here", 
                    "✖ - apples",
