...
$stmt_prev = $conn->prepare("SELECT eng_quiz1 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>English Skills - Lesson 1 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "What is the vowel sound used for the word 'apple'?",
                options: [
                    "△ - UH",
                    "〇 - AH", 
                    "✖ - IH",
            ...
            {
                question: "What is the vowel sound used for the word 'igloo'?",
                options: [
                    "△ - UH",
                    "〇 - AH",
                    "✖ - IH", 
            ...
            {
                question: "What is the vowel sound used for the word 'umbrella'?",
                options: [
                    "△ - UH", 
                    "〇 - AH",
                    "✖ - IH",
            ...
            {
                question: "What is the vowel sound used for the word 'orange'?",
                options: [
                    "△ - UH",
                    "〇 - AH",
                    "✖ - IH",
            ...
            {
                question: "What is the vowel sound used for the word 'egg'?",
                options: [
                    "△ - UH",
                    "〇 - AH",
                    "✖ - EH", 
            ...
            {
                question: "What is the vowel sound used for the word 'fish'?",
                options: [
                    "△ - UH",
                    "〇 - AH",
                    "✖ - IH", 
            ...
            {
                question: "What is the vowel sound used for the word 'up'?",
                options: [
                    "△ - UH", 
                    "〇 - EH",
                    "✖ - AH",
            ...
            {
                question: "What is the vowel sound used for the word 'ant'?",
                options: [
                    "△ - UH",
                    "〇 - AH", 
                    "✖ - EH",
            ...
            {
                question: "What is the vowel sound used for the word 'eggplant'?",
                options: [
                    "△ - EH", 
                    "〇 - AH",
                    "✖ - IH",
