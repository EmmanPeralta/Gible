...
$stmt_prev = $conn->prepare("SELECT comm_quiz1 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Comm. Skills - Lesson 1 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "When greeting a person, what should you do?",
                options: [
                    "△ - Wave",
                    "〇 - Look into their eyes",
                    "✖ - Shout their name",
                    "☐ - None of the above"
                ],
                correct: 1 // 〇
            ...
            {
                question: "When a person is greeted, what should they do?",
                options: [
                    "△ - Ignore you",
                    "〇 - Shouted",
                    "✖ - Make eye contact",
            ...
            {
                question: "When someone praises you for a task, how can you show them you are happy?",
                options: [
                    "△ - Cry",
                    "〇 - Turn away",
                    "✖ - Smile",
            ...
            {
                question: "What does it mean when a person walks toward a friend after being called?",
                options: [
                    "△ - They want to be alone",
                    "〇 - They are not paying attention",
                    "✖ - They are showing understanding and interest ",
                    "☐ - They did not hear their friend"
                ],
                correct: 2 // ✖
            },
            {
                ...
                options: [
                    "△ - To ignore others",
                    "〇 - To help cooperate with others",
                    "✖ - To play games",
                    "☐ - To speak louder"
                ],
                correct: 1 // 〇
            ...
            {
                question: "What can help a person learn to follow requests from others?",
                options: [
                    "△ - Giving them toys",
                    "〇 - Helping them practice listening and following instructions ",
            ...
            {
                question: "Listening is also good for _____?",
                options: [
                    "△ - Ignoring sounds around you",
                    "〇 - Recognizing different sounds ",
                    "✖ - Making loud noises",
                    "☐ - Avoiding sounds"
                ],
                correct: 1 // 〇
            ...
            {
                question: "What can help a person learn to recognize sounds around them?",
                options: [
                    "△ - Playing with toys",
                    "〇 - Not paying attention to sounds",
                    "✖ - Talking louder",
            ...
            {
                question: "What does listening to sounds teach a person to do?",
                options: [
                    "△ - Recognize and identify sounds",
                    "〇 - Ignore sounds",
                    "✖ - Make sounds louder",
                    "☐ - Create new sounds"
                ],
            ...
            {
                question: "What kinds of sounds should a child learn to recognize?",
                options: [
                    "△ - Sounds from nature",
                    "〇 - Sounds from machines",
            ...
            function showQuestion() {
                ...
                document.getElementById('question-box').innerHTML =
                    ...
                    (window.questions[window.currentQuestion].img ? `<img src="${window.questions[window.currentQuestion].img}" alt="" style="max-width:200px;display:block;margin:12px auto;">` : '') +
                    optionsMarkup +
                    `</div>`;
