...
$stmt_prev = $conn->prepare("SELECT comm_quiz3 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Comm. Skills - Lesson 3 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "Which one makes a SOFT SOUND?",
                options: [
                    "△ <img src='../images/CommSkills/Quiz/birdsinging.jpg' style='width:161px;height:auto;'>", 
                    "〇 <img src='../images/CommSkills/Quiz/firetruck.png' style='width:174px;height:auto;'>",
                    "✖ <img src='../images/CommSkills/Quiz/megaphone.jpg' style='width:130px;height:auto;'>",
                    "☐ <img src='../images/CommSkills/Quiz/thunderstorm.jpg' style='width:130px;height:auto;'>"
                ],
                correct: 0 // △
            },
            {
                question: "Which one makes a LOUD SOUND?",
                options: [
                    "△ <img src='../images/CommSkills/Quiz/megaphone.jpg' style='width:130px;height:auto;'>", 
                    "〇 <img src='../images/CommSkills/Quiz/birdsinging.jpg' style='width:160px;height:auto;'>",
                    "✖ <img src='../images/CommSkills/Quiz/whisper.jpg' style='width:130px;height:auto;'>",
                    "☐ <img src='../images/CommSkills/Quiz/tiptoe.jpg' style='width:130px;height:auto;'>"
                ],
                correct: 0 // △
            },
            {
                question: "Which sound will make you cover your ears?",
                options: [
                    "△ <img src='../images/CommSkills/Quiz/whisper.jpg' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/CommSkills/Quiz/windblowing.jpg' style='width:260px;height:auto;'>",
                    "✖ <img src='../images/CommSkills/Quiz/megaphone.jpg' style='width:130px;height:auto;'>", 
                    "☐ <img src='../images/CommSkills/Quiz/tiptoe.jpg' style='width:130px;height:auto;'>"
                ],
                correct: 2 // ✖
            },
            {
                ...
                img: '../images/CommSkills/Quiz/happyface.png',
                options: [
                    "△ - Surprised",
                    "〇 - Bored",
                    "✖ - Happy", 
            ...
            {
                question: "What can we learn from looking at someone's face?",
                img: '../images/CommSkills/Quiz/expressions.png',
                options: [
                    "△ - What they ate for lunch",
                    "〇 - What their name is",
                    "✖ - What they are doing",
            ...
            },
            {
                ...
                img: '../images/CommSkills/Quiz/thinking.png',
                options: [
                    "△ - Thinking", 
                    "〇 - Running",
                    "✖ - Talking loudly",
            ...
            {
                question: "After thinking of an idea, what is the person in the picture doing now?",
                img: '../images/CommSkills/Quiz/kididea.png',
                options: [
                    "△ - Singing",
                    "〇 - Running",
                    "✖ - Drawing the idea", 
            ...
            {
                question: "When someone looks angry like in the picture, what should we do?",
                img: '../images/CommSkills/Quiz/angryperson.jpg',
                options: [
                    "△ - Laugh at them",
                    "〇 - Ignore them",
            ...
            {
                question: "What is this person doing in the picture?",
                img: '../images/CommSkills/Quiz/ideahead.png',
                options: [
                    "△ - Picture on wall",
                    "〇 - Thinking of an idea", 
                    "✖ - A toy",
                    "☐ - A snack"
                ],
                correct: 1 // 〇
            ...
            {
                question: "What happens when we turn a thought into something we can see or touch?",
                img: '../images/CommSkills/Quiz/becomesidea.png',
                options: [
                    "△ - Disappears",
                    "〇 - It turns into an idea", 
                    "✖ - Stays in our head",
                    "☐ - Turns to sound"
                ],
                correct: 1 // 〇
                ...
                if (window.currentQuestion >= window.questions.length) {
                    ...
                    resultBox.innerHTML = `
                        <div id="result-content" class="result-content">
                            ...
                            <!-- Bottom Button Row -->
                                <button class="back-button speak-on-hover" data-label="Back to Communication Lessons" style="padding:0.6rem 1.2rem; font-size:1.1rem; margin-top: 5px" onclick="saveScoreAndGoBack()">
                                    Back to Communication Lessons
                                </button>
                        </div>
                    `;
        ...
        <script>
            ...
            fetch('../save_quiz_result.php', {
                ...
                .then(() => {
                    window.location.href = 'comm.lessons.php';
                })
                .catch(() => {
                    window.location.href = 'comm.lessons.php';
                });
