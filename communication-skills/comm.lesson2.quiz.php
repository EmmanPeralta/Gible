...
$stmt_prev = $conn->prepare("SELECT comm_quiz2 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Comm. Skills - Lesson 2 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "What is the big person in the picture called?",
                img: '../images/CommSkills/Quiz/fatheranddaughter.jpg',
                options: [
                    "△ - Mother",
                    "〇 - Son",
                    "✖ - Father", 
            ...
            {
                question: "What is the little person in the picture called?",
                img: '../images/CommSkills/Quiz/fatheranddaughter.jpg',
                options: [
                    "△ - Daughter",
                    "〇 - Father",
            ...
            {
                question: "What is the big person in the picture called?",
                img: '../images/CommSkills/Quiz/mother1quiz2.jpg',
                options: [
                    "△ - Mother", 
                    "〇 - Son",
                    "✖ - Father",
            ...
            {
                question: "The person in the picture is a BOY, which clothes does he wear to play with friends?",
                img: '../images/CommSkills/Quiz/boy1quiz2.jpg',
                options: [
                    "△ <img src='../images/CommSkills/Quiz/girldress.jpg' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/CommSkills/Quiz/motherclothes.jpg' style='width:102px;height:auto;'>",
                    "✖ <img src='../images/CommSkills/Quiz/boyclothes.png' style='width:83px;height:auto;'>", 
                    "☐ <img src='../images/CommSkills/Quiz/fatherworkclothes.jpg' style='width:155px;height:auto;'>"
                ],
                correct: 2 // ✖
            },
            {
                question: "The person in the picture is a GIRL, which clothes does she wear when with friends?",
                img: '../images/CommSkills/Quiz/girl2quiz2.png',
                options: [
                    "△ <img src='../images/CommSkills/Quiz/girldress.jpg' style='width:130px;height:auto;'>", 
                    "〇 <img src='../images/CommSkills/Quiz/motherclothes.jpg' style='width:102px;height:auto;'>",
                    "✖ <img src='../images/CommSkills/Quiz/boyclothes.png' style='width:83px;height:auto;'>",
            ...
            {
                question: "The person in the picture is a FATHER, which clothes does he wear for work?",
                img: '../images/CommSkills/Quiz/father2quiz2.png',
                options: [
                    "△ <img src='../images/CommSkills/Quiz/girldress.jpg' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/CommSkills/Quiz/motherclothes.jpg' style='width:102px;height:auto;'>",
                    "✖ <img src='../images/CommSkills/Quiz/boyclothes.png' style='width:83px;height:auto;'>",
            ...
            {
                question: "The person in the picture is a MOTHER, which clothes does she wear for shopping?",
                img: '../images/CommSkills/Quiz/mother2quiz2.png',
                options: [
                    "△ <img src='../images/CommSkills/Quiz/girldress.jpg' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/CommSkills/Quiz/motherclothes.jpg' style='width:102px;height:auto;'>", 
                    "✖ <img src='../images/CommSkills/Quiz/boyclothes.png' style='width:83px;height:auto;'>",
            ...
            {
                question: "If you are good at coloring pictures, what is your ability?",
                options: [
                    "△ - Cleaning",
                    "〇 - Drawing and Coloring", 
                    "✖ - Building blocks",
                    "☐ - Running"
                ],
                correct: 1 // 〇
            ...
            {
                question: "If you are good at helping your friends, what is your ability?",
                options: [
                    "△ - Playing by yourself",
                    "〇 - Solving hard math problems",
            ...
            {
                question: "If you are fast on your feet, what is your ability?",
                options: [
                    "△ - Running", 
                    "〇 - Coloring Neatly",
                    "✖ - Reading Books",
