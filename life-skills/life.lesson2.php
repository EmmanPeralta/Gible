...
<title>Life Skills - Lesson 2</title>
...
<div class="lesson-slider">
    <div class="slider-header speak-on-hover" data-label="Life Lesson 2">Life Lesson 2</div>
...
<script>
    window.addEventListener('DOMContentLoaded', function () {
        const slides = [
        { img: '../images/LifeSkills/Lessons/life.lesson2.page1.png', label: "In this lesson, you will learn about the dangers of unhealthy foods." },
        { img: '../images/LifeSkills/Lessons/life.lesson2.page2.png', label: "Unhealthy foods does not help your body do its important work." },
        { img: '../images/LifeSkills/Lessons/life.lesson2.page3.png', label: "These foods can fill your belly, but they don’t give the fuel your body needs." },
        { img: '../images/LifeSkills/Lessons/life.lesson2.page4.png', label: "Sugar gives you quick energy, but too much can make your body crash and feel tired." },
        { img: '../images/LifeSkills/Lessons/life.lesson2.page5.png', label: "Fast foods like burgers are tasty, but if you eat too many, your body will feel slow and weak." },
        { img: '../images/LifeSkills/Lessons/life.lesson2.page6.png', label: "Instant foods are quick to make, but they offer few nutrients to us." }
    ];

    if (typeof mountLessonSlider === 'function') {
        mountLessonSlider({ slides, quizHref: 'life.lesson2.quiz.php' });
    }
    });
    </script>
