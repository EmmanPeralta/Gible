...
$stmt_prev = $conn->prepare("SELECT life_quiz3 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Life Skills - Lesson 3 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "Which meal gives us the energy to start the day?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.lunch1.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.dinner1.png' style='width:130px;height:auto;'>",
                    "✖ <img src='../images/LifeSkills/Quiz/life.breakfast1.png' style='width:130px;height:auto;'>", 
                    "☐ <img src='../images/LifeSkills/Quiz/life.snack1.png' style='width:130px;height:auto;'>"
                ],
                correct: 2 // ✖
            },
            {
                question: "What happens if we eat too much breakfast?",
                options: [
                    "△ - We get taller",
                    "〇 - We get sleepy", 
                    "✖ - We get sick",
            ...
            {
                question: "Which meal fills our stomach in the middle of the day?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.lunch1.png' style='width:130px;height:auto;'>", 
                    "〇 <img src='../images/LifeSkills/Quiz/life.dinner1.png' style='width:130px;height:auto;'>",
                    "✖ <img src='../images/LifeSkills/Quiz/life.breakfast1.png' style='width:130px;height:auto;'>",
            ...
            {
                question: "Lunch helps us to...",
                options: [
                    "△ - Rest at night",
                    "〇 - Keep working, learning, and playing during the day", 
                    "✖ - Sleep early", 
                    "☐ - Skip dinner"
                ],
                correct: 1 // 〇
            ...
            {
                question: "Which is the last big meal of the day?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.lunch1.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.snack1.png' style='width:130px;height:auto;'>",
                    "✖ <img src='../images/LifeSkills/Quiz/life.dinner1.png' style='width:130px;height:auto;'>", 
                    "☐ <img src='../images/LifeSkills/Quiz/life.breakfast1.png' style='width:130px;height:auto;'>"
                ],
                correct: 2 // ✖
            },
            {
                question: "What does dinner do for our body?",
                options: [
                    "△ - Makes us sleepy in the morning",
                    "〇 - Helps us rest and grow while we sleep", 
                    "✖ - Makes us skip a meal", 
                    "☐ - Gives us energy in the middle of the day"
                ],
                correct: 1 // 〇
            },
            {
                question: "A snack is usually eaten when?",
                options: [
                    "△ - After breakfast", 
                    "〇 - After dinner", 
                    "✖ - Before sleeping",
            ...
            {
                question: "What is the purpose of a snack?",
                options: [
                    "△ - To make us sleepy", 
                    "〇 - Give extra energy during the day", 
                    "✖ - To make us sick",
                    "☐ - To replace lunch" 
                ],
                correct: 1 // 〇
            ...
            {
                question: "Which one is a PROPER snack?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.junkfood3.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.junkfood2.png' style='width:130px;height:auto;'>",
                    "✖ <img src='../images/LifeSkills/Quiz/life.junkfood1.png' style='width:130px;height:auto;'>",
                    "☐ <img src='../images/LifeSkills/Quiz/life.snack2.png' style='width:130px;height:auto;'>" 
                ],
                correct: 3 // ☐
            },
            {
                question: "Which one is NOT one of the three main meals?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.breakfast1.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.snack1.png' style='width:130px;height:auto;'>", 
                    "✖ <img src='../images/LifeSkills/Quiz/life.lunch1.png' style='width:130px;height:auto;'>",
