...
<title>Life Skills - Lesson 1</title>
...
<div class="lesson-slider">
    <div class="slider-header speak-on-hover" data-label="Life Lesson 1">Life Lesson 1</div>
...
<script>
    window.addEventListener('DOMContentLoaded', function () {
        const slides = [
        { img: '../images/LifeSkills/Lessons/life.lesson1.page1.png', label: "In this lesson, we will learn about healthy foods." },
        { img: '../images/LifeSkills/Lessons/life.lesson1.page2.png', label: "Healthy foods are like super fuel that help our bodies grow big, tall, and strong!" },
        { img: '../images/LifeSkills/Lessons/life.lesson1.page3.png', label: "They help us fight off germs so we can stay healthy!" },
        { img: '../images/LifeSkills/Lessons/life.lesson1.page4.png', label: "Vegetables are like batteries that fill us up with energy to play, run, and jump!" },
        { img: '../images/LifeSkills/Lessons/life.lesson1.page5.png', label: "Juicy fruits are packed with vitamins that make us sparkle with health!" },
        { img: '../images/LifeSkills/Lessons/life.lesson1.page6.png', label: "Meats are like building blocks that make our bodies tough and powerful!" },
    ];

    if (typeof mountLessonSlider === 'function') {
        mountLessonSlider({ slides, quizHref: 'life.lesson1.quiz.php' });
    }
    });
    </script>
