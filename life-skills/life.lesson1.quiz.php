...
$stmt_prev = $conn->prepare("SELECT life_quiz1 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Life Skills - Lesson 1 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "Which food here helps us stay away from sickness?",
                options: [
            ...
            {
                question: "Which food here helps us stay active and energetic?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.fruit2.png' style='width:130px;height:auto;'>",
            ...
            {
                question: "Which food here helps us build body muscles?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.fruit2.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.vegetable2.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.meat3.png' style='width:130px;height:auto;'>", 
                    "☐ <img src='../images/LifeSkills/Quiz/life.vegetable1.png' style='width:130px;height:auto;'>"
                ],
                correct: 2 // ⨉
            ...
            {
                question: "What does meat provide for your body?",
                options: [
                    "△ - Give us energy",
                    "〇 - Builds body muscles", 
                    "⨉ - Prevent sickness",
                    "☐ - Give us vitamins"
                ],
                correct: 1 // 〇
            ...
            {
                question: "What does vegetables do to your body?",
                options: [
                    "△ - Builds body muscles",
                    "〇 - Gives us energy", 
                    "⨉ - Gives us vitamins",
            ...
            {
                question: "What does fruit do for your body?",
                options: [
                    "△ - Builds body muscle",
                    "〇 - Gives us fever",
                    "⨉ - Prevent sickness", 
            ...
            {
                question: "Which food makes our body strong?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.fruit2.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.vegetable2.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.meat2.png' style='width:130px;height:auto;'>", 
                    "☐ <img src='../images/LifeSkills/Quiz/life.vegetable1.png' style='width:130px;height:auto;'>"
                ],
                correct: 2 // ⨉
            },
            ...
            {
                question: "Which food keeps our body healthy?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.vegetable1.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.fruit1.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.meat2.png' style='width:130px;height:auto;'>", 
            ...
            {
                question: "Which food helps your body muscles the most?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.vegetable1.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.fruit1.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.meat3.png' style='width:130px;height:auto;'>", 
