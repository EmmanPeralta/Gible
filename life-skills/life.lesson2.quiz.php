...
$stmt_prev = $conn->prepare("SELECT life_quiz2 FROM quiz_scores WHERE first_name=? AND last_name=?");
...
<head>
    ...
    <title>Life Skills - Lesson 2 - Quiz</title>
...
<body>
    <!-- Layout: Emotion Tracker (left) + Quiz (right) -->
        ...
        <script>
            window.questions = [
            {
                question: "Which food is quick to make but not very healthy?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.vegetable1.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.fruit1.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.junkfood1.png' style='width:130px;height:auto;'>", 
                    "☐ <img src='../images/LifeSkills/Quiz/life.meat3.png' style='width:130px;height:auto;'>"
                ],
                correct: 2 // ⨉
            },
            {
                question: "Which food here tastes good but can make our body weak if we eat too much?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.junkfood2.png' style='width:130px;height:auto;'>", 
                    "〇 <img src='../images/LifeSkills/Quiz/life.meat2.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.fruit1.png' style='width:130px;height:auto;'>",
                    "☐ <img src='../images/LifeSkills/Quiz/life.vegetable1.png' style='width:130px;height:auto;'>"
                ],
                correct: 0 // △
            },
            {
                question: "What is bad about eating too much junk food?",
                options: [
                    "△ - It makes us stronger",
                    "〇 - It makes our body weak", 
            ...
            {
                question: "What is the problem with instant food?",
                options: [
                    "△ - It gives vitamins",
                    "〇 - It helps us gain energy",
                    "⨉ - It gives few nutrients", 
                    "☐ - It prevents sickness"
                ],
                correct: 2 // ⨉
            },
            {
                question: "Which food is NOT healthy?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.vegetable2.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.meat2.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.fruit1.png' style='width:130px;height:auto;'>",
                    "☐ <img src='../images/LifeSkills/Quiz/life.junkfood3.png' style='width:130px;height:auto;'>" 
                ],
                correct: 3 // ☐
            },
            {
                question: "Which food gives us quick energy but is not good for the body if we eat too much?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.vegetable2.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.meat2.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.junkfood4.png' style='width:130px;height:auto;'>", 
                    "☐ <img src='../images/LifeSkills/Quiz/life.fruit3.png' style='width:130px;height:auto;'>"
                ],
                correct: 2 // ⨉
            },
            {
                question: "Fast food can taste yummy, but what happens if we eat too much every day?",
                options: [
                    "△ - We can get sick", 
                    "〇 - We get vitamins",
                    "⨉ - We gain strong muscles",
                    "☐ - We stay healthy"
                ],
                correct: 0 // △
            },
            {
                question: "Which food is healthier for our body?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.junkfood3.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.fruit2.png' style='width:130px;height:auto;'>", 
                    "⨉ <img src='../images/LifeSkills/Quiz/life.junkfood2.png' style='width:130px;height:auto;'>",
                    "☐ <img src='../images/LifeSkills/Quiz/life.junkfood1.png' style='width:130px;height:auto;'>"
                ],
                correct: 1 // 〇
            ...
            {
                question: "What happens if we eat too much instant food?",
                options: [
                    "△ - We become healthier",
                    "〇 - We gain vitamins from it",
            ...
            {
                question: "Which food should we eat less often?",
                options: [
                    "△ <img src='../images/LifeSkills/Quiz/life.vegetable1.png' style='width:130px;height:auto;'>",
                    "〇 <img src='../images/LifeSkills/Quiz/life.fruit1.png' style='width:130px;height:auto;'>",
                    "⨉ <img src='../images/LifeSkills/Quiz/life.junkfood1.png' style='width:130px;height:auto;'>", 
                ...
                if (window.currentQuestion >= window.questions.length) {
                    ...
                    resultBox.innerHTML = `
                        <div id="result-content" class="result-content">
                            ...
                            <!-- Bottom Button Row -->
                                <button class="back-button speak-on-hover" data-label="Back to Life Lessons" style="padding:0.6rem 1.2rem; font-size:1.1rem; margin-top: 5px" onclick="saveScoreAndGoBack()">
        ...
        <script>
            ...
            fetch('../save_quiz_result.php', {
                ...
                .then(() => {
                    window.location.href = 'life.lessons.php';
                })
                .catch(() => {
                    window.location.href = 'life.lessons.php';
                });
