...
<title>Life Skills - Lesson 3</title>
...
<div class="nav-buttons2">
    <a href="life.lessons.php" class="speak-on-hover" data-label="Back">BACK</a>
    <a href="#" onclick="openModal(); return false;" class="speak-on-hover" data-label="Open settings">SETTINGS</a>
</div>

<!-- Lesson Slider -->
<div class="lesson-slider">
    <div class="slider-header speak-on-hover" data-label="Life Lesson 3">Life Lesson 3</div>
...
<script>
    window.addEventListener('DOMContentLoaded', function () {
        const slides = [
        { img: '../images/LifeSkills/Lessons/life.lesson3.page1.png', label: "We need to eat the right kind and right amount of food every day." },
        { img: '../images/LifeSkills/Lessons/life.lesson3.page2.png', label: "There are 3 main meals: Breakfast, Lunch, and Dinner. There is also a small meal between lunch and dinner called a Snack or a Meryenda." },
        { img: '../images/LifeSkills/Lessons/life.lesson3.page3.png', label: "Breakfast. A light meal that gives us energy to start the day. Eating too much can make us more sleepy." },
        { img: '../images/LifeSkills/Lessons/life.lesson3.page4.png', label: "Lunch. A full meal that fills our stomach so we can keep learning, working, and playing." },
        { img: '../images/LifeSkills/Lessons/life.lesson3.page5.png', label: "Dinner gives us energy at night and helps our body rest and grow while we sleep." },
        { img: '../images/LifeSkills/Lessons/life.lesson3.page6.png', label: "Snack. A small meal that gives extra energy between lunch and dinner." }
    ];

    if (typeof mountLessonSlider === 'function') {
        mountLessonSlider({ slides, quizHref: 'life.lesson3.quiz.php' });
    }
    });
    </script>
